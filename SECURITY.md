...
| Version | Supported |
|---------|-----------|
| **1.3.0** (current) | Yes — report security issues against this release |
| 1.2.4 | Superseded; upgrade to current when possible |
| 1.2.3 | Superseded; upgrade to current when possible |
